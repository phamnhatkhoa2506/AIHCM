...
# (da bo dau san luc build - xem tier1_filter._strip_accents), ymin/xmin/ymax/xmax, score, source.
...
# ven cho region_embeddings.npy) - chi loai khoi ket qua khop nhan o Tang 1 (xem tier1_filter.py).
