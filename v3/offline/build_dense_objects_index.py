...
# 2026-08-14: da do cong bang (container am, cung phuong phap) - batch=16 nhanh hon batch=8
# ~26% (384.9 vs 304.7 anh/phut/container), batch=32 van cham hon batch=8 (da test truoc do).
# Diem ngot la 16 - tang MAX_IMAGES_PER_CALL 8->16.
MAX_IMAGES_PER_CALL = 16
CHECKPOINT_EVERY_CHUNKS = 10  # 10*16=160 anh/checkpoint, giu nguyen tan suat cu (20*8=160)
...
def run(limit: int | None = None) -> None:
    ...
    try:
        ...
        map_results = detector.detect_batch_from_volume.map(
            _rel_paths_gen(), [labels] * len(batches),
