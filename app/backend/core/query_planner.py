...
# 2026-08-21 (theo yeu cau nguoi dung: "tạo file mới trực tiếp vô hệ thống mới... đừng mount vào
# v3 nữa") - ban sao RIENG cua app/ (khong con dung chung voi v3/online/query_planner.py) - file
# nay gio nam PHANG trong backend/core/ (cung cap voi config.py/app_flags.py/...) nen KHONG can
# tu cheo sys.path nua (backend/bootstrap.py da them core/ vao sys.path 1 lan duy nhat).
