...
# 2026-08-21 (theo yeu cau nguoi dung: "app/ tach biet v3/") - ban sao rieng, dung _APP_ROOT
# (app/.cache/...) thay vi _V3_ROOT.
from config import _APP_ROOT
from video_audio import local_video_path, read_video_bytes

VIDEO_CACHE_DIR = _APP_ROOT / ".cache" / "video_full"  # video gốc trích 1 lần/video_id, giữ lại
CLIP_CACHE_DIR = _APP_ROOT / ".cache" / "video_clips"  # đoạn ngắn đã cắt, giữ lại theo (video_id,t)
...
CORRECTED_FRAME_CACHE_DIR = _APP_ROOT / ".cache" / "trake_corrected_frames"
